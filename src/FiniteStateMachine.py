...
class DFA:
    ...
    def __init__(self, arg1, arg2, arg3, dictionary_symbols=None, path=""):
        ...
        if isinstance(arg1, str):
            self.init_from_ltl(arg1, arg2, arg3, dictionary_symbols, path)
    ...
    def init_from_ltl(self, ltl_formula, num_symbols, formula_name, dictionary_symbols, path):
        # From LTL to DFA
        #   parser = LTLfParser()
        ...
        dfa_folder = f'{path}DFA/'
        os.makedirs(dfa_folder, exist_ok=True)
        # Make sure the directory exists
        with open(f"{dfa_folder}symbolicDFA.dot", "w+") as f:
            f.write(dot)
        ...
        dfa = dot2dfa(dot)
        #graph = dfa.to_graphviz()
        #graph.render(path + "/symbolicDFAs/" + formula_name + "_g")
        ...
        self.write_dot_file(f"{dfa_folder}simpleDFA_end.dot")
        ...
        self.write_dot_file(f"{dfa_folder}simpleDFA_final.dot")
