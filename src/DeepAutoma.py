...
class DeepDFA(nn.Module):
    def __init__(self, numb_of_actions, numb_of_states, numb_of_output):
        ...
        self.trans_prob = torch.zeros((numb_of_actions, numb_of_states, numb_of_states), requires_grad=False, device=device)
        ...
        self.fin_matrix = torch.zeros((numb_of_states, numb_of_output), requires_grad=False, device=device)
